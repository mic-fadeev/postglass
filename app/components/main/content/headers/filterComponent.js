...
// temp solution
const stringActions = ['contains', 'does not contain', 'is exactly', 'is not exactly',
  'begins with', 'ends with', 'like'];
const numericActions = ['=', '≠', '<', '>', '≤', '≥', 'BETWEEN'];
...
class FilterComponent extends Component {
  ...
  applyFilter = () => {
    ...
    this.props.getTableContent({
      ...
      filterAction: this.state.action,
